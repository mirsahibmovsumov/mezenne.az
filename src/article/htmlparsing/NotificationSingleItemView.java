...
public class NotificationSingleItemView extends Activity {
	// Declare Variables
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		arrow.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(NotificationSingleItemView.this,
						Article.class);
		...
		position = (int) db.getMaxId();

		name = db.getArticle((int) db.getMaxId()).getName();
	...
	class DownloadArticle extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(
					NotificationSingleItemView.this, R.style.MyTheme);
